<template>
  <div class="investmentPolicy">
    <div
      ...
      :key="index"
      class="card-list"
      @click="$router.push({path:'/parkNoticeDetail',query:{noticeId: item.noticeId}})"
    >
      <div class="card-list-content">
        <div class="card-list-title">{{ item.noticeTitle }}</div>
        <div class="card-list-text">{{ item.noticeBiref }}</div>
