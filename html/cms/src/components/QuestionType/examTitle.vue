<template>
    <div>
        <!-- 试题名称新增状态 -->
        <div class="examBlock bgcolor" v-if="isAdd">
            <el-form>
                <el-form-item prop="researchProject">
                    <el-input v-model="formData.researchProject" placeholder="请在这里输入试卷的名称"></el-input>
                </el-form-item>
                <el-row type="flex" justify="space-between">
                    <el-col :span="8">
                        <el-form-item prop="trainer" label="培训讲师:" label-width="73px">
                            <el-input v-model="formData.trainer" placeholder="请输入培训讲师"></el-input>
        ...
        <!-- 试题名称编辑状态 -->
        <div class="examBlock" v-if="!isAdd&&!isModifyTitle" v-on:mouseover="changeActive($event)" v-on:mouseout="removeActive($event)">
            <div class="editIcon"><el-button size="samll" @click="modifyTitle"><i style="font-size:18px;" class="el-icon-edit-outline"></i></el-button></div>
        ...
        <!-- 试题名称修改状态 -->
        <div class="examBlock" v-if="!isAdd&&isModifyTitle" v-click-outside="saveFirst">
            <el-form :model="parentData">
                <el-form-item prop="researchProject">
                    <el-input v-model="parentData.researchProject" placeholder="请在这里输入试卷的名称"></el-input>
                </el-form-item>
                <el-row type="flex" justify="space-between">
                    <el-col :span="8">
                        <el-form-item prop="trainer" label="培训讲师:" label-width="73px">
                            <el-input v-model="parentData.trainer" placeholder="请输入培训讲师"></el-input>
