	...
	<div class="resultPage">
		<my-container>
			<el-card class="box-card">
				<el-progress type="circle" :percentage="100" status="text" >{{resultInfo.achievement}}分</el-progress>
				<p >{{resultInfo.achievement>=resultInfo.passScore?'恭喜您，成功通过本次考试！':'很遗憾没用通过考试！'}}</p>
				<el-row>
					
					<el-col :span="8">
						<div class="grid-content bg-purple">
							<el-progress type="circle" :percentage="0" status="text" :width="100" :stroke-width='3'>
								<p>正确率 </p>
