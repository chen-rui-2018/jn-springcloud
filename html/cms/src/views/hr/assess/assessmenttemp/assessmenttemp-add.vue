<template>
  <div>
    ...
    <el-form-item label="模板名称：" prop="id">
      <el-input style="width: 205px;" v-model="templateName"/>
    </el-form-item>
      ...
      <el-table :data="tableData" ref="table" tooltip-effect="dark" border stripe style="width: 95%" @selection-change='selectRow'>
        ...
        <el-table-column  label="目标类别" align="center">
          <template slot-scope="scope">
            <el-input v-model="scope.row.targetCategory"></el-input>
          </template>
        </el-table-column>
        ...
        <el-table-column label="考核目标">
          <template slot-scope="scope">
            <el-input v-model="scope.row.assessmentTarget"></el-input>
          </template>
        </el-table-column>
        ...
        <el-table-column label="评分细则">
          <template slot-scope="scope">
            <el-input v-model="scope.row.scoreRubric"></el-input>
          </template>
        </el-table-column>
        <el-table-column label="牵头考核部门">
          <template slot-scope="scope">
            <el-input v-model="scope.row.leadAssessmentDepartment"></el-input>
          </template>
        </el-table-column>
        <el-table-column label="得分">
          <template slot-scope="scope">
            <el-input v-model="scope.row.assessmentScore"></el-input>
          </template>
        </el-table-column>
        <el-table-column label="扣分原因">
          <template slot-scope="scope">
            <el-input v-model="scope.row.causeDeduction"></el-input>
          </template>
        </el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      submitForm(){
        ...
        let rows = {templateName:this.templateName,recordList:this.commitRows}
      ...
      submitRow(row){
        ...
        let rows = {templateName:this.templateName,recordList:this.oneRow}
