<template>
  <div class="attendanceList">
    ...
    <!-- 表格 -->
    <el-table v-loading="listLoading" ref="multipleTable" :data="attendanceList" border fit highlight-current-row
              style="width: 100%;height:100%;" @row-click="showRow">
      <el-table-column label="选择" width="50" align="center">
        <template slot-scope="scope">
          <el-radio class="radio" checked="checked" v-model="currJobNumber" :label="scope.row.jobNumber">&nbsp;
          </el-radio>
        </template>
      </el-table-column>
