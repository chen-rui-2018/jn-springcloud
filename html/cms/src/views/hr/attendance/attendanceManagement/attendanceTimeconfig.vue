    ...
    <div class="bd">
      <el-table
        ...
        <el-table-column label="班次" align="center" prop="shift">
          <template slot-scope="scope">
            <el-select
              ...
              style="width: 100px"
              class="filter-item"
              @change="setAttendanceType(scope.row,scope.row.shift)">
        ...
        <el-table-column label="操作" align="center" min-width="100" width="200" class-name="small-padding fixed-width">
          <template slot-scope="scope">
            <el-button v-if="!scope.row.disabled" type="text" @click="submitForm(scope.row)">保存</el-button>
            <el-button v-if="scope.row.disabled" type="text" @click="update(scope.row,scope.$index)">修改</el-button>
