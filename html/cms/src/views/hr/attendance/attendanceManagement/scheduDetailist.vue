  ...
  <div class="scheduDetail">
    ...
    <el-form :model="listQuery" class="info-form" :inline="true">
      ...
      <el-form-item label="部门:" lable-position="right" label-width="80px">
        <el-select v-model="listQuery.departmentId" placeholder="请选择" clearable style="width: 200px"
                   class="filter-item">
      ...
      <el-form-item label="姓名:" lable-position="right" label-width="80px">
        <el-input v-model.trim="listQuery.name" maxlength="200" style="width: 200px" placeholder=""
                  clearable/>
      </el-form-item>
      ...
      <div class="btn-group">
        <el-form-item class="form-btn">
          ...
          <el-button class="filter-item" type="primary" :disabled="listQuery.schedulMonth<nextMonth" @click="update">修改</el-button>
          <el-button class="filter-item" type="primary" :disabled="!canSave" @click="save">保存</el-button>
    ...
    <!-- 表格 -->
    <el-table v-loading="listLoading" ref="multipleTable" :data="scheduDetailist" border fit highlight-current-row
              style="width: 100%;height:100%;" class="selecttable" @selection-change="handleSelectionChange">
      <el-table-column
        type="selection"
        width="55">
      </el-table-column>
      ...
      <el-table-column label="部门" align="center" width="200">
        <template slot-scope="scope">
          <el-select v-if="!scope.row.disabled" v-model="scope.row.departmentId" placeholder="请选择" clearable
                     class="filter-item" :disabled="scope.row.disabled" @change="setDepartMentName(scope.row,scope.$index)">
            <el-option label="请选择" value=""/>
            <el-option v-for="item in departmentList" :key="item.departmentId" :label="item.departmentName"
                       :value="item.departmentId"/>
          </el-select>
      ...
      <el-table-column label="姓名" align="center" prop="name" width="150">
        <template slot-scope="scope">
          <el-input v-if="!scope.row.disabled" v-model.trim="scope.row.name" maxlength="100" placeholder="请输入姓名"
                    clearable :disabled="scope.row.disabled" />
      ...
      <el-table-column label="1号" align="center" prop="number1">
        <template slot-scope="scope">
          <el-input v-if="!scope.row.disabled" v-model.trim="scope.row.number1" maxlength="50" placeholder=""
                     :disabled="scope.row.disabled"
                    onkeypress="return event.keyCode>=48&&event.keyCode<=49" :maxlength="1"/>
          <span v-else>{{scope.row.number1}}</span>
        </template>
      </el-table-column>
      <el-table-column label="2号" align="center" prop="number2">
        <template slot-scope="scope">
          <el-input v-if="!scope.row.disabled" v-model.trim="scope.row.number2" maxlength="50" placeholder=""
                     :disabled="scope.row.disabled"
                    onkeypress="return event.keyCode>=48&&event.keyCode<=49" :maxlength="1"/>
      ...
      <el-table-column label="3号" align="center" prop="number3">
        <template slot-scope="scope">
          <el-input v-if="!scope.row.disabled" v-model.trim="scope.row.number3" maxlength="50" placeholder=""
                     :disabled="scope.row.disabled"
                    onkeypress="return event.keyCode>=48&&event.keyCode<=49" :maxlength="1"/>
      ...
      <el-table-column label="4号" align="center" prop="number4">
        <template slot-scope="scope">
          <el-input v-if="!scope.row.disabled" v-model.trim="scope.row.number4" maxlength="50" placeholder=""
                     :disabled="scope.row.disabled"
                    onkeypress="return event.keyCode>=48&&event.keyCode<=49" :maxlength="1"/>
      ...
      <el-table-column label="5号" align="center" prop="number5">
        <template slot-scope="scope">
          <el-input v-if="!scope.row.disabled" v-model.trim="scope.row.number5" maxlength="50" placeholder=""
                     :disabled="scope.row.disabled"
                    onkeypress="return event.keyCode>=48&&event.keyCode<=49" :maxlength="1"/>
      ...
      <el-table-column label="6号" align="center" prop="number6">
        <template slot-scope="scope">
          <el-input v-if="!scope.row.disabled" v-model.trim="scope.row.number6" maxlength="50" placeholder=""
                     :disabled="scope.row.disabled"
                    onkeypress="return event.keyCode>=48&&event.keyCode<=49" :maxlength="1"/>
      ...
      <el-table-column label="7号" align="center" prop="number7">
        <template slot-scope="scope">
          <el-input v-if="!scope.row.disabled" v-model.trim="scope.row.number7" maxlength="50" placeholder=""
                     :disabled="scope.row.disabled"
                    onkeypress="return event.keyCode>=48&&event.keyCode<=49" :maxlength="1"/>
      ...
      <el-table-column label="8号" align="center" prop="number8">
        <template slot-scope="scope">
          <el-input v-if="!scope.row.disabled" v-model.trim="scope.row.number8" maxlength="50" placeholder=""
                     :disabled="scope.row.disabled"
                    onkeypress="return event.keyCode>=48&&event.keyCode<=49" :maxlength="1"/>
      ...
      <el-table-column label="9号" align="center" prop="number9">
        <template slot-scope="scope">
          <el-input v-if="!scope.row.disabled" v-model.trim="scope.row.number9" maxlength="50" placeholder=""
                     :disabled="scope.row.disabled"
                    onkeypress="return event.keyCode>=48&&event.keyCode<=49" :maxlength="1"/>
      ...
      <el-table-column label="10号" align="center" prop="number10">
        <template slot-scope="scope">
          <el-input v-if="!scope.row.disabled" v-model.trim="scope.row.number10" maxlength="50" placeholder=""
                     :disabled="scope.row.disabled"
                    onkeypress="return event.keyCode>=48&&event.keyCode<=49" :maxlength="1"/>
      ...
      <el-table-column label="11号" align="center" prop="number11">
        <template slot-scope="scope">
          <el-input v-if="!scope.row.disabled" v-model.trim="scope.row.number11" maxlength="50" placeholder=""
                     :disabled="scope.row.disabled"
                    onkeypress="return event.keyCode>=48&&event.keyCode<=49" :maxlength="1"/>
      ...
      <el-table-column label="12号" align="center" prop="number12">
        <template slot-scope="scope">
          <el-input v-if="!scope.row.disabled" v-model.trim="scope.row.number12" maxlength="50" placeholder=""
                     :disabled="scope.row.disabled"
                    onkeypress="return event.keyCode>=48&&event.keyCode<=49" :maxlength="1"/>
      ...
      <el-table-column label="13号" align="center" prop="number13">
        <template slot-scope="scope">
          <el-input v-if="!scope.row.disabled" v-model.trim="scope.row.number13" maxlength="50" placeholder=""
                     :disabled="scope.row.disabled"
                    onkeypress="return event.keyCode>=48&&event.keyCode<=49" :maxlength="1"/>
      ...
      <el-table-column label="14号" align="center" prop="number14">
        <template slot-scope="scope">
          <el-input v-if="!scope.row.disabled" v-model.trim="scope.row.number14" maxlength="50" placeholder=""
                     :disabled="scope.row.disabled"
                    onkeypress="return event.keyCode>=48&&event.keyCode<=49" :maxlength="1"/>
      ...
      <el-table-column label="15号" align="center" prop="number15">
        <template slot-scope="scope">
          <el-input v-if="!scope.row.disabled" v-model.trim="scope.row.number15" maxlength="50" placeholder=""
                     :disabled="scope.row.disabled"
                    onkeypress="return event.keyCode>=48&&event.keyCode<=49" :maxlength="1"/>
      ...
      <el-table-column label="16号" align="center" prop="number16">
        <template slot-scope="scope">
          <el-input v-if="!scope.row.disabled" v-model.trim="scope.row.number16" maxlength="50" placeholder=""
                     :disabled="scope.row.disabled"
                    onkeypress="return event.keyCode>=48&&event.keyCode<=49" :maxlength="1"/>
      ...
      <el-table-column label="17号" align="center" prop="number17">
        <template slot-scope="scope">
          <el-input v-if="!scope.row.disabled" v-model.trim="scope.row.number17" maxlength="50" placeholder=""
                     :disabled="scope.row.disabled"
                    onkeypress="return event.keyCode>=48&&event.keyCode<=49" :maxlength="1"/>
      ...
      <el-table-column label="18号" align="center" prop="number18">
        <template slot-scope="scope">
          <el-input v-if="!scope.row.disabled" v-model.trim="scope.row.number18" maxlength="50" placeholder=""
                     :disabled="scope.row.disabled"
                    onkeypress="return event.keyCode>=48&&event.keyCode<=49" :maxlength="1"/>
      ...
      <el-table-column label="19号" align="center" prop="number19">
        <template slot-scope="scope">
          <el-input v-if="!scope.row.disabled" v-model.trim="scope.row.number19" maxlength="50" placeholder=""
                     :disabled="scope.row.disabled"
                    onkeypress="return event.keyCode>=48&&event.keyCode<=49" :maxlength="1"/>
      ...
      <el-table-column label="20号" align="center" prop="number20">
        <template slot-scope="scope">
          <el-input v-if="!scope.row.disabled" v-model.trim="scope.row.number20" maxlength="50" placeholder=""
                     :disabled="scope.row.disabled"
                    onkeypress="return event.keyCode>=48&&event.keyCode<=49" :maxlength="1"/>
      ...
      <el-table-column label="21号" align="center" prop="number21">
        <template slot-scope="scope">
          <el-input v-if="!scope.row.disabled" v-model.trim="scope.row.number21" maxlength="50" placeholder=""
                     :disabled="scope.row.disabled"
                    onkeypress="return event.keyCode>=48&&event.keyCode<=49" :maxlength="1"/>
      ...
      <el-table-column label="22号" align="center" prop="number22">
        <template slot-scope="scope">
          <el-input v-if="!scope.row.disabled" v-model.trim="scope.row.number22" maxlength="50" placeholder=""
                     :disabled="scope.row.disabled"
                    onkeypress="return event.keyCode>=48&&event.keyCode<=49" :maxlength="1"/>
      ...
      <el-table-column label="23号" align="center" prop="number23">
        <template slot-scope="scope">
          <el-input v-if="!scope.row.disabled" v-model.trim="scope.row.number23" maxlength="50" placeholder=""
                     :disabled="scope.row.disabled"
                    onkeypress="return event.keyCode>=48&&event.keyCode<=49" :maxlength="1"/>
      ...
      <el-table-column label="24号" align="center" prop="number24">
        <template slot-scope="scope">
          <el-input v-if="!scope.row.disabled" v-model.trim="scope.row.number24" maxlength="50" placeholder=""
                     :disabled="scope.row.disabled"
                    onkeypress="return event.keyCode>=48&&event.keyCode<=49" :maxlength="1"/>
      ...
      <el-table-column label="25号" align="center" prop="number25">
        <template slot-scope="scope">
          <el-input v-if="!scope.row.disabled" v-model.trim="scope.row.number25" maxlength="50" placeholder=""
                     :disabled="scope.row.disabled"
                    onkeypress="return event.keyCode>=48&&event.keyCode<=49" :maxlength="1"/>
      ...
      <el-table-column label="26号" align="center" prop="number26">
        <template slot-scope="scope">
          <el-input v-if="!scope.row.disabled" v-model.trim="scope.row.number26" maxlength="50" placeholder=""
                     :disabled="scope.row.disabled"
                    onkeypress="return event.keyCode>=48&&event.keyCode<=49" :maxlength="1"/>
      ...
      <el-table-column label="27号" align="center" prop="number27">
        <template slot-scope="scope">
          <el-input v-if="!scope.row.disabled" v-model.trim="scope.row.number27" maxlength="50" placeholder=""
                     :disabled="scope.row.disabled"
                    onkeypress="return event.keyCode>=48&&event.keyCode<=49" :maxlength="1"/>
      ...
      <el-table-column label="28号" align="center" prop="number28">
        <template slot-scope="scope">
          <el-input v-if="!scope.row.disabled" v-model.trim="scope.row.number28" maxlength="50" placeholder=""
                     :disabled="scope.row.disabled"
                    onkeypress="return event.keyCode>=48&&event.keyCode<=49" :maxlength="1"/>
      ...
      <el-table-column label="29号" align="center" prop="number29">
        <template slot-scope="scope">
          <el-input v-if="!scope.row.disabled" v-model.trim="scope.row.number29" maxlength="50" placeholder=""
                     :disabled="scope.row.disabled"
                    onkeypress="return event.keyCode>=48&&event.keyCode<=49" :maxlength="1"/>
      ...
      <el-table-column label="30号" align="center" prop="number30">
        <template slot-scope="scope">
          <el-input v-if="!scope.row.disabled" v-model.trim="scope.row.number30" maxlength="50" placeholder=""
                     :disabled="scope.row.disabled"
                    onkeypress="return event.keyCode>=48&&event.keyCode<=49" :maxlength="1"/>
      ...
      <el-table-column label="31号" align="center" prop="number31">
        <template slot-scope="scope">
          <el-input v-if="!scope.row.disabled" v-model.trim="scope.row.number31" maxlength="50" placeholder=""
                     :disabled="scope.row.disabled"
                    onkeypress="return event.keyCode>=48&&event.keyCode<=49" :maxlength="1"/>
