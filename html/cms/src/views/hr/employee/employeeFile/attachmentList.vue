  ...
  <div>
    ...
    <el-form :model="listQuery" class="info-form" :inline="true">
      ...
      <el-form-item label="档号:" label-width="54px">
        <el-input v-model="listQuery.fileId" disabled maxlength="20" placeholder="" class="filter-item"
                  clearable style="width:150px;"/>
      </el-form-item>
      <el-form-item label="题名:" label-width="54px">
        <el-input v-model="listQuery.titleName" disabled maxlength="20" placeholder="" class="filter-item"
                  clearable style="width:150px;"/>
      </el-form-item>
    ...
    <h3>附件列表</h3>
    <hr>
    <el-button type="primary" style="width:80px;float:right;margin-right:10px;margin-bottom:10px;border-radius: 20px; "
               @click="showUploadForm">上传
    </el-button>
    <el-table v-loading="listLoading" ref="multipleTable" :data="attachmentList" border fit highlight-current-row
              style="width: 100%;">
    ...
    <el-dialog title="员工档案附件上传" :visible.sync="dialogImportVisible" :modal-append-to-body="false"
               :close-on-click-modal="false" class="dialog-import" :before-close="handleClose">
      <div>
    ...
    <template v-if="attachFormVisible">
      <el-dialog :visible.sync="attachFormVisible" title="员工档案附件" width="450px">
        <el-form ref="attachForm" :rules="rules" :model="attachForm" label-position="right" label-width="130px"
                 style="max-width:400px;margin-left:20px">
          <el-form-item label="附件名称:" prop="fileName">
            <el-input v-model.trim="attachForm.fileName" maxlength="200" style="width: 200px" placeholder="请输入文件名称"
                      clearable/>
          </el-form-item>
        </el-form>
