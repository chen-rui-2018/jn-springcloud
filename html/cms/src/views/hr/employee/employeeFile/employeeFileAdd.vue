    ...
    <el-form ref="addForm" :model="addForm" :rules="rules" label-width="120px" >
      ...
      <el-col :span="12">
        <el-form-item label="归类：" prop="nodeName">
          <el-input v-model="addForm.nodeName" disabled style="width: 200px" placeholder="" clearable></el-input>
        </el-form-item>
      </el-col>

        <el-col :span="12">
          <el-form-item label="登记部门：" prop="regDepartment">
            <el-input v-model="addForm.regDepartment" style="width: 200px" placeholder="请输入登记部门" clearable></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-col :span="12">
        <el-form-item label="文号：" prop="symbol">
          <el-input v-model="addForm.symbol" style="width: 200px" placeholder="请输入文号" clearable></el-input>
        </el-form-item>
      </el-col>
      </el-row>
      ...
      <el-form-item label="题名：" prop="titleName">
        <el-input v-model="addForm.titleName" style="width: 200px" placeholder="请输入题名" clearable></el-input>
      </el-form-item>
      </el-col>

      <el-col :span="12">
      <el-form-item label="责任人：" prop="personLiable">
        <el-input v-model="addForm.personLiable" style="width: 200px" placeholder="请输入责任人" clearable></el-input>
      </el-form-item>
      </el-col>
      </el-row>
      ...
      <el-col :span="12">
        <el-form-item label="备注：" prop="remark">
          <el-input type="textarea" style="width: 200px" v-model="addForm.remark"></el-input>
        </el-form-item>
      </el-col>
      ...
      <el-form-item>
        <el-button type="primary" :disabled="isDisabled" @click="title==='新增员工档案'?submitForm():updateData()">提交</el-button>
