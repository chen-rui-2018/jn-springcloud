<template>
  <div class="employeeFileList">
    ...
    <el-container>
      <el-aside width="200px">
        <div class="tree-search">
          <el-input v-model="treeNodeName" placeholder="搜索名称" style="margin-bottom:10px;" suffix-icon="el-icon-search"></el-input>
          <el-button type="primary"  style="width:200px;" @click="addCardParent()">添加一级员工档案分类</el-button>
        </div>
        <el-tree  ref="tree" :data="treeList" :props="defaultProps" @node-click="handleNodeClick" node-key="id"
                   :highlight-current="true" @node-contextmenu="rightClick" :filter-node-method="filterNode"
                  style="min-height:613px;"></el-tree>
          ...
          <el-dialog :visible.sync="treeFormVisible" title="员工档案分类" width="450px">
            <el-form ref="treeForm" :rules="rules" :model="treeForm" label-position="right" label-width="130px"
              ...
              <el-form-item label="档案分类名称:" prop="nodeName">
                <el-input v-model.trim="treeForm.nodeName" maxlength="200" style="width: 200px" placeholder="请输入档案分类名称"
                          clearable/>
              </el-form-item>
            </el-form>
      ...
      <el-main>
        ...
        <el-form :model="listQuery" class="info-form" :inline="true">
          <el-form-item label="档号:" label-width="54px">
            <el-input v-model="listQuery.fileId" maxlength="20" placeholder="" class="filter-item"
                      clearable @keyup.enter.native="handleFilter"/>
          </el-form-item>
          <el-form-item label="题名:" label-width="54px">
            <el-input v-model="listQuery.titleName" maxlength="20" placeholder="" class="filter-item"
                      clearable @keyup.enter.native="handleFilter"/>
          </el-form-item>
        ...
        <el-table v-loading="listLoading" ref="multipleTable" :data="employeeFileList" border fit highlight-current-row
                  style="width: 100%;">
    ...
    <file-upload :title="'员工档案导入'" :importUrl="importUrl" :dialogVisible="dialogImportVisible"
                 :templatePath="'/static/file/员工档案模板.xlsx'" :limit="1"
...
<script>
  import {
    ...
    deleteEmployeeFile, importEmployeeFile, exportEmployeeFile
