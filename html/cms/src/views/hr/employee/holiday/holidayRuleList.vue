      ...
      <div class="con-rule">
        <ul>
          ...
          <li v-for="(item,index) in holidayRuleList" :key="item.index" class="con-rule-item">
            ...
            <el-input-number :disabled="setInputDisable(item)" v-model="item.reachedYear"  :min="0" :max="99" label=""></el-input-number>
            ...
            <span>年不满</span> <!--<input :disabled="setInputDisable(item)" v-model="item.notFullYear" class="shortInput"
                                    maxlength="3" type="number" placeholder="" clearable>-->
            <el-input-number :disabled="setInputDisable(item)" v-model="item.notFullYear"  :min="0" :max="99" label=""></el-input-number>
            <span>年，年休假</span> <!--<input :disabled="setInputDisable(item)" v-model="item.annualLeave" class="shortInput"
                                      maxlength="3" type="number" placeholder="" clearable>-->
            <el-input-number :disabled="setInputDisable(item)" v-model="item.annualLeave"  :min="0" :max="99" label=""></el-input-number>
            <span>天</span>
            <el-button
