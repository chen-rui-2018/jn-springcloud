  ...
  <div class="addForm">
    ...
    <el-form ref="addForm" :model="addForm" :rules="rules" label-width="120px">
      <el-row>
        <el-col :span="12">
          <el-form-item label="姓名：" prop="name">
            <el-input v-model="addForm.name" style="width: 200px" placeholder="请输入姓名" clearable></el-input>
          </el-form-item>
        </el-col>
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="个人邮箱：" prop="mailbox">
            <el-input v-model="addForm.mailbox" style="width: 200px" placeholder="请输入邮箱" clearable></el-input>
          </el-form-item>
        </el-col>

        <el-col :span="12">
          <el-form-item label="手机号码：" prop="phone">
            <el-input v-model="addForm.phone" style="width: 200px" placeholder="请输入联系电话" clearable></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="学历：" prop="educationId">
            <el-select v-model="addForm.educationId" placeholder="请选择" clearable style="width: 200px"
                       class="filter-item">
              <el-option label="请选择" value=""/>
        ...
        <el-col :span="12">
          <el-form-item label="毕业院校：" prop="graduaAcademy">
            <el-input v-model="addForm.graduaAcademy" style="width: 200px" placeholder="请输入毕业院校" clearable></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="证件号：" prop="certificateNumber">
            <el-input v-model="addForm.certificateNumber" style="width: 200px" placeholder="请输入证件号"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row style="margin-top:40px;">
        <el-form-item>
          <el-button type="primary" :disabled="isDisabled" @click="title==='新增简历库'?submitForm():updateData()">提交
          </el-button>
          <el-button @click="cancel" style="margin-left:50%;">取消</el-button>
        </el-form-item>
      </el-row>
    </el-form>
    </el-card>
          ...
          getResumeDatabaseById(query.id).then(res => {
            if (res.data.code === '0000') {
              ...
              if(this.addForm.resumeInfo && this.addForm.resumeInfo!=''){
                var obj = {}
                let index = this.addForm.resumeInfo.lastIndexOf('\/');
                let fileName  = this.addForm.resumeInfo.substring(index + 1, this.addForm.resumeInfo.length);
