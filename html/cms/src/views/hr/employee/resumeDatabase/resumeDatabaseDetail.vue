  ...
  <div class="addForm">
    ...
    <el-form ref="form" :model="addForm" label-width="150px" >
      ...
      <el-form-item style="text-align: center;">
        <el-button type="primary" @click="cancel" style="margin-left:-75px;">返回</el-button>
      </el-form-item>
    </el-form>
    </el-card>
  </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      download(){
        let fileName=this.addForm.resumeInfo.substring(this.addForm.resumeInfo.lastIndexOf(".")+1)
