    ...
    <el-card>
      <el-form ref="addForm" :model="addForm" :rules="rules" label-width="120px">
        <el-form-item label="试题类型：" prop="testQuestionType">
          <el-select v-model="addForm.testQuestionType" placeholder="请选择" clearable style="width: 200px"
                     class="filter-item" @change="clearForm">
        ...
        <el-form-item label="试题内容：" prop="examinationQuestion">
          <el-input type="textarea" v-model="addForm.examinationQuestion" placeholder="" clearable></el-input>
        </el-form-item>
        <div class="exam-bg">
          ...
          <div class="cl"></div>
          <div class="exam-option-radio" v-if="addForm.testQuestionType=='1'">
              ...
              <ul class="exam-option">
                <li v-for="(item,index) in addForm.optionList" :key="index">
                  <el-radio :label="item.optionId">
                    <el-form-item :label="item.optionId+':'" :prop="'optionList.' + index + '.optionName'"
                                  :rules="{required: true, message: '请输入选项内容', trigger: 'blur'}" label-width="30px">
                      <el-input type="text" v-model="item.optionName" style="width:800px;" placeholder=""
                                clearable></el-input>
                    </el-form-item>
                  </el-radio>
                  <el-button v-if="index>3" type="danger" size="small" icon="el-icon-delete" circle
                             @click="deleteOption(index)"></el-button>
                </li>
              </ul>
            </el-radio-group>
            <div class="cl"></div>
          ...
          <div class="exam-option-checkbox" v-if="addForm.testQuestionType=='2'">
          ...
          <div class="exam-option-question" v-if="addForm.testQuestionType=='3'">

            <el-form-item label="答案：" prop="answerHtml">
              <el-input type="textarea" v-model="addForm.answerHtml" placeholder="" clearable></el-input>
            </el-form-item>

          </div>
          <div class="exam-option-judge" v-if="addForm.testQuestionType=='4'">
          ...
          <div>
            <el-row>
              <el-col :span="12">
                <el-form-item label="试题分数：" prop="fraction">
                  <el-input type="number" v-model="addForm.fraction" placeholder="" clearable
                            style="width: 200px" :maxlength="3"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="难易度：" prop="examinationDifficulty">
                  <el-select v-model="addForm.examinationDifficulty" placeholder="请选择" clearable style="width: 200px"
                             class="filter-item">
                    <el-option label="请选择" value=""/>
            ...
            <el-form-item label="试题分析：" prop="itemAnalysis">
              <el-input type="textarea" v-model="addForm.itemAnalysis" placeholder="" clearable></el-input>
            </el-form-item>

            <el-form-item>
              <el-button type="primary" :disabled="isDisabled" @click="addForm.testQuestionId==''?submitForm():updateData()">确定
              </el-button>
...
<script>
  ...
  export default {
  	props:['examItem'],
    data() {
      let checkAnswerHtml = (rule, value, callback) => {
        if (!value) {
