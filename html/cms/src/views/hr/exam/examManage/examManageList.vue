<template>
	<div class="examManagelist">
		<el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect">
			...
			<el-button class="addexamBtn" @click="addExam" type="primary" size="small" icon="el-icon-plus">创建考试</el-button>
		</el-menu>
		<!---->

		<div class="header-tabs">
			<el-tabs type="border-card" v-model="initFrom.status" @tab-click="handleClick">
				...
				<el-card class="exambox box-card" v-for="(item,index) in dataList" :key="index">
					...
					<div class="examListright">
						<div class="examListrightTop">
							...
							<el-select v-model='value' @change='((val)=>{selectChange(val, item)})' placeholder="更多操作">
						...
						<div class="examListrightbottom">
							<span><i class="el-icon-data-line"></i>查看成绩</span>
							<span><i class="el-icon-setting"></i>考试设置</span>
						</div>
					</div>
				</el-card>
			</el-tabs>
			<div class="inputBox">
				<el-input placeholder="输入名称查询" v-model="initFrom.examinaName" class="input-with-select">
