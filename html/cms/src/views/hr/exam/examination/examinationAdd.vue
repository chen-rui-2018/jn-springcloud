      ...
      <el-form ref="addForm" :model="addForm" :rules="rules" label-width="120px">
        ...
        <div class="exam-bg">
          ...
          <div>
            <el-row>
              <el-col :span="12">
                <el-form-item label="试题分数：" prop="fraction">
                  <el-input-number v-model="addForm.fraction"  :min="1" :max="1000" label=""></el-input-number>
                </el-form-item>
              </el-col>
              <el-col :span="12">
            ...
            <el-form-item>
              <el-button type="primary" :disabled="isDisabled" @click="title==='新增试题'?submitForm():updateData()">提交
              </el-button>
