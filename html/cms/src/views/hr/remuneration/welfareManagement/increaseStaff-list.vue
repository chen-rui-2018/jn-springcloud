<template>
  <div v-loading="listLoading" class="increaseStaffList">
      ...
      <el-dialog :visible.sync="increaseStaffAddFormVisible" title="增减员计划" width="750px">
        <el-form ref="increaseStaffAddForm" :model="increaseStaffAddFromData" label-width="150px">
          <el-form-item label="姓名" prop="name" class="inline">
            <el-input type="textarea" style="width: 350px;" readonly="readonly" v-model="increaseStaffAddFromData.name"/>
          ...
          <el-form-item label="社保基数" prop="socialInsuranceBase" class="inline">
            <el-input type="textarea" style="width: 350px;" readonly="readonly"v-model="socialInsuranceBaseData"/>
          ...
          <el-form-item label="公积金基数" prop="reserveBase" class="inline">
            ...
            <el-input type="textarea" style="width: 350px;" readonly="readonly" v-model="increaseStaffAddFromReserveBaseData"/>
    ...
    <!--获取参保人员信息对话框-->
    <el-dialog  title="员工信息" :visible.sync="openStaffNamePageVisible" style="width: 950px;" >
    ...
    <template v-if="socialInsuranceBasePageVisibleVisible">
      <el-dialog :visible.sync="socialInsuranceBasePageVisibleVisible" title="各项目基数" width="650px">
        <el-form ref="socialInsuranceBaseForm" :model="socialInsuranceBaseFormData" class="auto_form">
            <el-form-item label="参保方案" prop="insuredProgrammeId" class="inline">
              <el-input type="text" style="width: 200px;" v-model="socialInsuranceBaseFormData.schemeName"/>
            </el-form-item>
          <el-form-item v-for="(domain, index) in socialInsuranceBasePageInit" :prop="domain.prop" :label="domain.label" :key="domain.key">
            <el-input type="text" style="width: 200px;" v-model="domain.value"/>
            <p style="height: 12px;margin-top: 0px;color:dodgerblue">基数范围[0-99999]</p>
          </el-form-item>
          <el-form-item>
    ...
    <template v-if="accumulationFundPageVisibleVisible">
      <el-dialog :visible.sync="accumulationFundPageVisibleVisible" title="各项目基数" width="650px">
        <el-form ref="socialInsuranceBaseForm" :model="accumulationFundPageVisibleVisibleData" class="auto_form">
          ...
          <el-form-item v-for="(domain, index) in reserveBasePageInit" :prop="domain.prop" :label="domain.label" :key="domain.key">
            <el-input type="text" style="width: 200px;" v-model="domain.value"/>
            <p style="height: 12px;margin-top: 0px;color:dodgerblue">基数范围[0-99999]</p>
          </el-form-item>
          <el-form-item>
