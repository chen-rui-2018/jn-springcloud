  ...
  <div class="dashboard-editor-container" style="height: 1000px">
    <el-form :inline="true" :model="listQuery" class="filter-bar">
      ...
      <el-form-item label="参保类型">
        <el-select v-model="listQuery.type" placeholder="请选择" clearable style="width: 150px" @change="changeProjectType"
                   class="filter-item">
      ...
      <el-col :span="5">
        <div style="height:66px; width: 200px;">
          ...
          <span style="width: 120px;float: right;line-height: 66px;display:inline-block;color: #666666">
            ...
            <img src="@/assets/images/up.png" v-if="imgs.insuredNumberUpPng" style="height: 20px;width: 10px;" alt="图片">
            <img src="@/assets/images/down.png" v-if="imgs.insuredNumberDownPng" style="height: 20px;width: 10px;" alt="图片">
          </span>
        </div>
      </el-col>
      <el-col :span="6" v-if="socialSecurityFlag">
        <div style="height:66px; width: 200px;">
          ...
          <span style="width: 120px;float: right;line-height: 66px;display:inline-block;color: #666666">
            ...
            <img src="@/assets/images/up.png" v-if="imgs.socialSecurityUpPng" style="height: 20px;width: 10px;" alt="图片">
            <img src="@/assets/images/down.png" v-if="imgs.socialSecurityDownPng" style="height: 20px;width: 10px;" alt="图片">
          </span>
        </div>
      </el-col>
      <el-col :span="6" v-if="accumulationFundFlag">
        <div style="height:66px; width: 170px;">
          ...
          <span style="width: 105px;float: right;line-height: 66px;display:inline-block;color: #666666">
            ...
            <img src="@/assets/images/up.png" v-if="imgs.accumulationFundUpPng" style="height: 20px;width: 10px;" alt="图片">
            <img src="@/assets/images/down.png" v-if="imgs.accumulationFundDownPng" style="height: 20px;width: 10px;" alt="图片">
          </span>
        </div>
      </el-col>
      <el-col :span="6">
        <div style="height:66px; width: 170px;">
          ...
          <span style="width: 105px;float: right;line-height: 66px;display:inline-block; color: #666666">
            ...
            <img src="@/assets/images/up.png" v-if="imgs.totalCostUpPng" style="height: 20px;width: 10px;" alt="图片">
            <img src="@/assets/images/down.png" v-if="imgs.totalCostDownPng" style="height: 20px;width: 10px;" alt="图片">
          </span>
  </div>
  </el-col>
    </el-row>
