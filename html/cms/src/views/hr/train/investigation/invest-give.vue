                ...
                <div class="modeCon">
                    ...
                    <el-row class="item">
                        ...
                        <el-col :span="19">
                            ...
                            <el-row class="maLink">
                                <el-col :span="10"><el-input v-model="formData.surveyUrl"></el-input></el-col>
                                <el-col :span="9" :offset="1">
                                    <el-button icon="el-icon-document" v-clipboard:copy="formData.surveyUrl" v-clipboard:success="clipboardSuccess">复制</el-button>
                                    <el-button icon="el-icon-message" @click="sendEmail">邮件</el-button>
                                    <el-button @click="jumpPage" type="primary" plain>打开</el-button>
                                </el-col>
                            </el-row>
                        </el-col>                       
                    </el-row>
                    ...
                    <el-row class="item">
                        ...
                        <el-col :span="19">
                            ...
                            <p v-if="formData.researchMethod == 2">
                                <el-checkbox :checked="formData.isShowName===1?true:false" v-model="formData.isShowName" :true-label=1 :false-label=2 label="姓名"></el-checkbox>
                                <el-checkbox :checked="formData.isShowJobNumber===1?true:false" v-model="formData.isShowJobNumber" :true-label=1 :false-label=2 label="工号"></el-checkbox>
                                <el-checkbox :checked="formData.isShowPhone===1?true:false" v-model="formData.isShowPhone" :true-label=1 :false-label=2 label="手机"></el-checkbox>
                            </p>
                        </el-col>                       
                    </el-row>
                </div>
            ...
            <div class="mode">
                ...
                <div class="modeCon">
                    <el-row class="item">
                        ...
                        <el-col :span="19">
                            <el-checkbox :checked="formData.frequencyLimit===1?true:false" v-model="formData.frequencyLimit" :true-label=1 :false-label=2 label="每个学员只能调研一次"></el-checkbox> 
                        </el-col>                       
                    </el-row>
                    <el-row class="item">
                        <el-col :span="5"><span class="item-l">显示设置：</span></el-col>
                        <el-col :span="19">
                           <el-checkbox :checked="formData.isShowTips===1?true:false" v-model="formData.isShowTips" :true-label=1 :false-label=2 label="调研后提示"></el-checkbox> 
                        </el-col>                       
                    </el-row>
                </div>
            </div>
            <el-row type="flex" justify="center"><el-col :span="1"><el-button @click="save" type="primary">保存</el-button></el-col></el-row>
        </el-card>
    </div>
</template>
...
export default {
    ...
    data() {
        return {
            activeName: 'second',
            // 二维码
            appSrc: 'http://localhost:9527/#/hr/train/investigation/invest-page?projectId='+this.$route.query.id,
            // 提交数据
            formData: {
                effectiveTimeEnd: '',
                effectiveTimeStart: '',
                ...
                surveyUrl: 'http://localhost:9527/#/hr/train/investigation/invest-page?projectId='+this.$route.query.id,
            }
        }
    },
    created() {
    ...
    methods: {
        ...
        // 调研页面
        jumpPage() {
            this.$router.push({ name: 'invest-page', query: { projectId: this.$route.query.id }})
        },
        // 复制
        clipboardSuccess() {
            this.$message({
