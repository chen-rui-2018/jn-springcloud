  ...
  <el-card>
    ...
    <div v-for="(item, index) of formData.questionList" :key="index">
      <Single
        ...
        ref="single"
        :qnum="index+1"
        @deleteQitem="deleteQitem(item, index)"
      />
      <Multiple
    ...
    <el-row type="flex" justify="center">
      <el-col :span="1">
        <el-button type="primary" @click="saveAll">生成问卷</el-button>
      </el-col>
    </el-row>
  </el-card>
</template>
...
export default {
  ...
  methods: {
    ...
    saveAll() {
      ...
      api('hr/train/quest/addInvestiageAndQuestionQuest', this.formData).then(
        res => {
