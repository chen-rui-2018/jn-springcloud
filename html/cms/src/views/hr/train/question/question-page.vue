                ...
                <el-col :span="16" :xs="22">
                    ...
                    <div v-if="!isEntry">
                        <div class="examList" v-for="(item,index) of examList">
                            <p style="font-size:14px;"><span>Q{{index+1}}</span>&nbsp;&nbsp;<span>{{item.titleName}}</span>&nbsp;&nbsp;<span>[{{item.titleType}}]</span>&nbsp;&nbsp;<span v-if="item.isShowAnswer">(必答)</span></p>
                            <div style="padding-left:26px;" v-if="item.titleType === 1 || item.titleType === 2">
                                <p style="font-size:14px;" v-for="(item2,index2) of item.titleOptionList">
                                    <el-radio v-model="item.answerList" v-if="item.titleType === 1" :label="upperCase[index2]"></el-radio>&nbsp;&nbsp;
                                    <el-checkbox v-model="item.answerList" v-if="item.titleType === 2">{{upperCase[index2]}}</el-checkbox>&nbsp;&nbsp;
                                    <span>{{item2.optionName}}</span>
                                </p>
                            </div>
                            <el-input v-if="item.titleType === 3" type="textarea" rows="5"></el-input>
                        </div>
