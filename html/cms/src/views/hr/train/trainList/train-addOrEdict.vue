      ...
      <el-row type="flex" justify="center">
        <el-col :span="16">
          <el-form :model="formData" ref="formData" label-width="100px">
            <el-form-item label="课程名称" prop="courseTitle" :rules="{required: true, message: '课程名称不能为空', trigger: 'blur'}">
              <el-col :span="11"><el-input v-model="formData.courseTitle" clearable></el-input></el-col>
            </el-form-item>
            <el-form-item label="培训老师" prop="trainTeacher" :rules="{required: true, message: '培训老师不能为空', trigger: 'blur'}">
                <el-col :span="11"><el-input v-model="formData.trainTeacher" clearable></el-input></el-col>
            </el-form-item>
            <el-form-item label="培训地点" prop="trainVenue" :rules="{required: true, message: '培训地点不能为空', trigger: 'blur'}">
                <el-col :span="11"><el-input v-model="formData.trainVenue" clearable></el-input></el-col>
            </el-form-item>
            <el-form-item label="培训时间" :rules="{required: true, message: '培训时间不能为空', trigger: 'blur'}">
                <el-col :span="11">
            ...
            <el-form-item label="课程介绍" prop="trainInfo" :rules="{required: true, message: '课程介绍不能为空', trigger: 'blur'}">
