<template>
  <el-scrollbar wrap-class="scrollbar-wrapper">
    ...
    <el-menu :show-timeout="200" :default-active="$route.path" :collapse="isCollapse" :router="true" mode="vertical" background-color="#304156" text-color="#bfcbd9" active-text-color="#409EFF" @open="handleOpen" @close="handleClose">
...
.s-logo{
  background:url('/static/corporate/logo/small-logo.png') center center no-repeat ;
}
</style>
