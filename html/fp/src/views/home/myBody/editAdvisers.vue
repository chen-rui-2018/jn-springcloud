  ...
  <div class="editAdvisers" >
    ...
    <!-- <div class="advisory_content"> -->
      ...
      <div v-show="showBtn" class="footer ct">
        <el-button v-show="!isConceal" size="mini" @click="acceptInvitation" class="mainColor accept">提交修改</el-button>
      </div> -->
...
//               // _this.basicForm.businessAreas = res.data.advisorServiceInfo.businessArea.split();
//               // }
//               // _this.basicForm.orgId = res.data.advisorServiceInfo.orgId;
