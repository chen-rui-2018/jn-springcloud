...
export default {
  ...
  computed: {
    isCenter() {
      const list =
        "enterpriseservice,investment,serMatHp,tfindex,actiCenter,incubatorEnterprises,compassView,declarationCenter,declarationTimely,talentsService,academicExchange,policyCenter,recruitmentList,profileDetails,noticeList,parkAdvantage";
