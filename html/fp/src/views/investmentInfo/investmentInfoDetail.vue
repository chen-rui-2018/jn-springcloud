  ...
  <div class="policyGuide0">
    <div class="graphicCon w">
      <div class="techContent w">
        <span class="pointer" @click="$router.push({path:'/investmentInfo'})">招商信息</span>
        <span>/</span>
        <span class="mainColor">招商信息详情</span>
      </div>
      <div class="agentInfo">
        <el-card>
          <div class="agent1">
          ...
          <div class="agent2 clearfix color2">
            <div>
              ...
              <div class="tag-btn" v-if="getGuideDetal.adFlag">
                <el-tag
                  v-for="(tag, tagIndex) in getGuideDetal.adFlag.split(',')"
                  :key="tagIndex"
                  class="tag-text"
                  size="mini"
                  color="#ECFCF2"
      ...
      <div class="proDel">
        <div class="agentDelTit">信息详情</div>
        <div class="agentDelCon pr">
          <el-card>
            <div class="agent1 clearfix">
              <div class="agentTil mainColor fl">招商信息内容</div>
...
<style lang="scss">
  ...
  .policyGuide0 {
    .detail-adCover {
      width: 100%;
      margin-top: 23px;
      box-shadow:0px 1px 9px 0px rgba(4,0,0,0.05);
      border-radius:6px;
    }
    .tag-btn {
      margin-top: 10px;
