  ...
  <div class="policyCenter0">
    <div class="policyCon">
        ...
        <div class="swiper-container">
          <div class="swiper-wrapper">
            <div class="swiper-slide" style="width:100%">
              <img src="@/../static/img/investment-policy.png" alt="">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="techContent w">
        ...
        <span>/</span>
        <span class="mainColor">招商政策</span>
      </div>
      <div class="policyTab  w">
        <div class="pr">
          <span class="wenzi color3">政策</span>
          <div class="filRight">
          ...
          <el-tab-pane label="全部" name="first">
            <ul class="fir">
              <li class="list-row" v-for="(i,k) in policyCenterListSearchResult" :key="k">
                ...
                <div class="fir2 list-row-cell mainColor" @click="$router.push({path:'/investmentPolicyDetail',query:{id:i.id}})">详情</div>
              </li>
            </ul>
          </el-tab-pane>
        </el-tabs>
