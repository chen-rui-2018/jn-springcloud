  ...
  <div class="policyGuide0">
    <div class="graphicCon w">
      <div class="techContent w">
        <span class="pointer" @click="$router.push({path:'/investmentPolicy'})">招商政策</span>
        <span>/</span>
        <span class="mainColor">招商政策详情</span>
      </div>
      <div class="agentInfo">
        <el-card>
          <div class="agent1">
        ...
        <div class="agentDelCon pr">
          <el-card>
            <div class="agent1 clearfix">
              <div class="agentTil mainColor fl">政策内容</div>
            ...
            <div class="agent2 color2" v-if="zankaiFlag">
              <div class="agent2Content" v-html="getGuideDetal.content"></div>
            </div>
          </el-card>
        </div>
      </div>
