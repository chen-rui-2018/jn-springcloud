...
public class WriteTest {
    ...
    public void writeV2007() throws IOException {
        OutputStream out = new FileOutputStream("C:\\2007.xlsx");
    ...
    public void writeV2003() throws IOException {
        OutputStream out = new FileOutputStream("C:\\2003.xls");
    ...
    @Test
    public void zdeleteTempFile(){
        File file2007 = new File("C:\\2007.xlsx");
        if(file2007.exists()) {
            file2007.delete();
        }
        File file2003 = new File("C:\\2003.xls");
        if(file2003.exists()) {
            file2003.delete();
        }
    }
