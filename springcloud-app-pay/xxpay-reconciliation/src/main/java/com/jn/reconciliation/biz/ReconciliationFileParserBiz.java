...
import com.jn.reconciliation.parser.ParserInterface;
...
public class ReconciliationFileParserBiz implements BeanFactoryAware {
	 ...
	 * @throws IOException
	 */
	public List<ReconciliationEntityVo> parser(TbPayReconciliationCheckBatch batch, File file, Date billDate, String interfaceCode) throws IOException {
