...
public class TbSysDictModule implements Serializable {
    private String id;
    ...
    public boolean equals(Object that) {
        ...
        TbSysDictModule other = (TbSysDictModule) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getModuleCode() == null ? other.getModuleCode() == null : this.getModuleCode().equals(other.getModuleCode()))
            && (this.getModuleValue() == null ? other.getModuleValue() == null : this.getModuleValue().equals(other.getModuleValue()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getModuleValue() == null) ? 0 : getModuleValue().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", moduleValue=").append(moduleValue);
