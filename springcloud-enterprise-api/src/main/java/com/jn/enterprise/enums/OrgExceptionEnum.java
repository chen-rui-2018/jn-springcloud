...
public enum OrgExceptionEnum  implements CodeAndMsg {
    ...
    LOGIN_ACCOUNT_NOT_ORG_MANAGE("5020519","当前登录用户不是机构管理员，不能把专员设为联系人"),
    ACCOUNT_NOT_ORG_ADVISOR("5020519","设为联系人的账号不是机构专员"),
    ...
    SAVE_OR_UPDATE_ORG_INFO_FAIL("5020531","保存或修改机构认证信息失败，审批流程启动失败"),
    ;
