package com.jn.enterprise.servicemarket.enums;
 ...
 * @modified By:
 */
public enum ServiceProductException  implements CodeAndMsg {
    ...
    ServiceProductException(String code, String message) {
        this.code = code;
