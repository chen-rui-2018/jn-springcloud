...
public class DataModelController  extends BaseController {
    ...
    public Result<List<TreeData>> getTargetTree(){
        //List<TreeData> list = dataModelService.getTargetTree();
    ...
    public Result<Integer> invalidTarget(String targetId){
        //Integer result = dataModelService.invalidTarget(targetId);
    ...
    public Result<Integer> updateTarget(@ModelAttribute TargetVO target){
        //Integer result = dataModelService.updateTarget(target);
        //return new Result(result);
        return new Result();
