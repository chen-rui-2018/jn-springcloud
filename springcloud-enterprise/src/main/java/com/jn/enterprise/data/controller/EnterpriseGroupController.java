...
public class EnterpriseGroupController  extends BaseController {
    ...
    @ApiOperation(value = "企业群组树中添加群组",notes = "返回保存结果,正常结果为1")
    ...
    @ApiOperation(value = "企业群组企业批量作废",notes = "返回作废结果,正常结果为1")
    ...
    public Result<Integer> invalidCompanyFromGroup(String groupId,String companyId[]){
        return new Result();
    }
    ...
    @ApiOperation(value = "企业恢复",notes = "返回恢复结果,正常结果为1")
    ...
    public Result<Integer> validCompanyFromGroup(String groupId,String companyId){
        return new Result();
    }
    ...
    @ApiOperation(value="预警人添加",notes = "返回成功与否,正常结果为1")
    @ApiImplicitParams({
    ...
    public Result<Integer> saveReminder(String linkName,String departmentId,String linkAccount,String departmentName){
        return new Result();
    }
    ...
    public Result<Integer> invalidReminder(String[] linkName,String departmentId,String linkAccount){
        return new Result();
    }
