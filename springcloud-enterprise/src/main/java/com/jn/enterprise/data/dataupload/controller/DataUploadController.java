package com.jn.enterprise.data.dataupload.controller;
...
public class DataUploadController  extends BaseController {
    ...
    public Result<PaginationData<List<CompanyDataList>>> getForm(@ModelAttribute CompanyDataParam param){
        return new Result();
    }
    ...
    public Result<ModelData> getFormStruct(String modelId){
        return new Result();
    }
    ...
    public Result saveCompanyFormData(@ModelAttribute ModelData data){
        return new Result();
    }
    ...
    public Result<CompanyDataList> getFormed(){
        return new Result();
    }
    ...
    public Result<ModelData> getCompanyFormedStruct(String fileId){
        return new Result();
    }
    ...
    public Result<PaginationData<List<CompanyDataStatisticsList>>> getFormView(@ModelAttribute CompanyDataStatisticsParam param){
        //fileType=1:企业 2园区
        return new Result();
    }
    ...
    public Result<PaginationData<List<CompanyDataList>>> getFormList(@ModelAttribute CompanyDataParam param){
        //fileType=1:企业 2园区
        return new Result();
    }
    ...
    public Result<ModelData> getFormedStruct(String modelId,String formTime,String modelCycle, String companyId,String groupId,String fillInFormDeadline ){
        return new Result();
    }
    ...
    public Result<PaginationData<List<CompanyDataList>>> getCurrentMonthTasks(){
        return new Result();
    }
    ...
    public Result saveTaskData(@ModelAttribute ModelData data){
        return new Result();
    }
    ...
    public Result<ModelData> getCurrentMonthForm(String fileId){
        return new Result();
    }
    ...
    public Result<PaginationData<List<CompanyDataList>>> getHostoryTask(@ModelAttribute CompanyDataParam param){
        return new Result();
    }
    ...
    public Result<ModelData> getGardenFormStruct(String fileId){
        return new Result();
    }
    ...
    public Result<PaginationData<List<GardenCheckList>>> getGardenCheckList(@ModelAttribute GardenCheckParam param){
        return new Result();
    }
    ...
    public Result<ModelData> getCheckOrLookInfo(String fileId){
        return new Result();
    }
    ...
    public Result<PaginationData<List<CompanyDataStatisticsList>>> getStatisticsList(@ModelAttribute CompanyDataStatisticsParam param){
        return new Result();
    }
    ...
    public Result<PaginationData<List<CompanyDataList>>> getStatisticsListInfo(@ModelAttribute CompanyDataParam param){
        return new Result();
    }
    ...
    public Result<ModelData> getStruct(String fileId){
        return new Result();
    }
    ...
    public Result gardenExport(String formTime,String modelName,String modelCycle){
        return new Result();
    }
