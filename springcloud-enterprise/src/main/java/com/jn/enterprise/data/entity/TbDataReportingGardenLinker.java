...
public class TbDataReportingGardenLinker implements Serializable {
    @ApiModelProperty("序列")
    private String id;
    ...
    public boolean equals(Object that) {
        ...
        TbDataReportingGardenLinker other = (TbDataReportingGardenLinker) that;
