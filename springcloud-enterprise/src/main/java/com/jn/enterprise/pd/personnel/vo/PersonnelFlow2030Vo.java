 ...
 *
 * @author： wzy
 * @date： Created on 2019/3/19 14:20
 * @version： v1.0
 * @modified By:
 */
@ApiModel("人才中心-发送预约辅导")
public class PersonnelFlow2030Vo extends PersonnelFlowNodeBaseAbstractVo implements Serializable {
    private static final long serialVersionUID = -5701980194398162646L;

    @Override
    public PersonnelFlowNodeEnum getFlowNodeEnum() {
        return PersonnelFlowNodeEnum.TWO_AREA_PLAN_COUNSEL_30;
    }
