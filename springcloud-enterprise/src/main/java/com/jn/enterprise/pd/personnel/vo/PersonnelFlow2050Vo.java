...
public class PersonnelFlow2050Vo extends PersonnelFlowNodeBaseAbstractVo implements Serializable {
    private static final long serialVersionUID = 3914391432159356187L;

    @Override
    public PersonnelFlowNodeEnum getFlowNodeEnum() {
        return PersonnelFlowNodeEnum.TWO_AREA_PLAN_COUNSEL_50;
    }
