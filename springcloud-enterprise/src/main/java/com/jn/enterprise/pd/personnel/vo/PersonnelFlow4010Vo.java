 ...
 *
 * @author： wzy
 * @date： Created on 2019/3/19 15:08
 * @version： v1.0
 * @modified By:
 */
@ApiModel("人才中心-上传答辩材料及发送预约辅导")
public class PersonnelFlow4010Vo extends PersonnelFlowNodeBaseAbstractVo implements Serializable {
    private static final long serialVersionUID = -8709003246900581783L;

    @Override
    public PersonnelFlowNodeEnum getFlowNodeEnum() {
        return PersonnelFlowNodeEnum.FOUR_AREA_ANSWER_COUNSEL_10;
    }
