 ...
 */
@ApiModel("企业-进行预约辅导")
public class PersonnelFlow4020Vo extends PersonnelFlowNodeBaseAbstractVo implements Serializable {

    private static final long serialVersionUID = -8584292648743696611L;

    @Override
    public PersonnelFlowNodeEnum getFlowNodeEnum() {
        return PersonnelFlowNodeEnum.FOUR_AREA_ANSWER_COUNSEL_20;
    }
