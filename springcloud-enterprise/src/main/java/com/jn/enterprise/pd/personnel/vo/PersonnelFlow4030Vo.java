...
public class PersonnelFlow4030Vo extends PersonnelFlowNodeBaseAbstractVo implements Serializable {
    private static final long serialVersionUID = 4257734267057038757L;

    @Override
    public PersonnelFlowNodeEnum getFlowNodeEnum() {
        return PersonnelFlowNodeEnum.FOUR_AREA_ANSWER_COUNSEL_30;
    }
