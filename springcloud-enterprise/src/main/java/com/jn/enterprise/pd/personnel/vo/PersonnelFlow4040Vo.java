 ...
 */
@ApiModel("企业-区级答辩辅导中")
public class PersonnelFlow4040Vo extends PersonnelFlowNodeBaseAbstractVo implements Serializable {
    private static final long serialVersionUID = 6776817217640411634L;

    @Override
    public PersonnelFlowNodeEnum getFlowNodeEnum() {
        return PersonnelFlowNodeEnum.FOUR_AREA_ANSWER_COUNSEL_40;
    }
