...
public class PersonnelFlow8030Vo extends PersonnelFlowNodeBaseAbstractVo implements Serializable {

    private static final long serialVersionUID = -194655442453289378L;

    @Override
    public PersonnelFlowNodeEnum getFlowNodeEnum() {
        return PersonnelFlowNodeEnum.EIGHT_CITY_ANSWER_COUNSEL_30;
    }
