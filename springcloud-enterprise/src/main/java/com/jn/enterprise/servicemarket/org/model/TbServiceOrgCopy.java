...
public class TbServiceOrgCopy implements Serializable {
    ...
    List<TbServiceOrgElementCopy> tb_service_org_element;

    @ApiModelProperty(value = "服务机构地址信息")
    List<TbServiceOrgInfoCopy> tb_service_org_info;
    ...
    public List<TbServiceOrgElementCopy> getTb_service_org_element() {
        return tb_service_org_element;
    }

    public void setTb_service_org_element(List<TbServiceOrgElementCopy> tb_service_org_element) {
        this.tb_service_org_element = tb_service_org_element;
    }

    public List<TbServiceOrgInfoCopy> getTb_service_org_info() {
        return tb_service_org_info;
    }

    public void setTb_service_org_info(List<TbServiceOrgInfoCopy> tb_service_org_info) {
