...
public class TbServiceMainArea implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        TbServiceMainArea other = (TbServiceMainArea) that;
        return (this.getMainCode() == null ? other.getMainCode() == null : this.getMainCode().equals(other.getMainCode()))
    ...
    public String toString() {
        ...
        sb.append(", mainCode=").append(mainCode);
