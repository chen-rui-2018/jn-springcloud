...
public class TbServiceMainRound implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        TbServiceMainRound other = (TbServiceMainRound) that;
        return (this.getMainRoundCode() == null ? other.getMainRoundCode() == null : this.getMainRoundCode().equals(other.getMainRoundCode()))
