...
/**
 * 环境监测
 * 返回设备各指标实时数据、设备的实时空气质量、设备的实时污染级别、实时南京市平均空气质量
 *
 * @Author： cm
 * @Date： Created on 2019/6/23 22:32
 * @Version： v1.0
 * @Modified By:
 */
public class EnvironmentMonitorRealTimeDataResult implements Serializable {

    private static final long serialVersionUID = 1500898659284828609L;
    /**
     * 设备各指标实时数据
     */
    private List<DeviceRealTimeDataResult> deviceRealTimeDataResults;
    /**
     * 获取设备实时空气质量
     */
    ...
    public void setDeviceRealTimeDataResults(List<DeviceRealTimeDataResult> deviceRealTimeDataResults) {
        this.deviceRealTimeDataResults = deviceRealTimeDataResults;
    }
