...
@ApiModel(value = "AssessmentManagePage", description = "考核管理分页实体")
public class AssessmentManagePage extends Page implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -6630783709938800647L;
