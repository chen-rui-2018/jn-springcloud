...
@ApiModel(value = "AttendanceManagementPage", description = "考勤管理分页实体")
public class AttendanceManagementPage extends Page implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -8937695455844611493L;
