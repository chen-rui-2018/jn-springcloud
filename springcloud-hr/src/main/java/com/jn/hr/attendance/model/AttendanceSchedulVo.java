...
@ApiModel(value = "AttendanceSchedulVo", description = "排班管理实体")
public class AttendanceSchedulVo extends BaseRowModel implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -5939856660656110500L;
