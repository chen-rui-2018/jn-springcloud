...
@ApiModel(value = "AttendanceTimeSetAdd", description = "考勤时间设置表添加实体")
public class AttendanceTimeSetAdd implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 5102040794715296762L;
