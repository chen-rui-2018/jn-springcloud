...
public class AppSinkServiceImpl implements AppSinkService {
     ...
     */
    @Override
    public JPushResult pushMessage(String content, String title, List<String> ids, String pushType, String platFromType,
        ...
        try {
            PushResult pu = new JPushClient(MASTER_SECRET, APP_KEY).sendPush(payload);
            BeanUtils.copyProperties(pu, jPushResult);
