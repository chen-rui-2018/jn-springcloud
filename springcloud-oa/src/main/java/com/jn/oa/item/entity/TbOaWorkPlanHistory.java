...
public class TbOaWorkPlanHistory implements Serializable {
    private String id;
    ...
    public void setOperateRecode(String operateRecode) {
        this.operateRecode = operateRecode == null ? null : operateRecode.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        TbOaWorkPlanHistory other = (TbOaWorkPlanHistory) that;
