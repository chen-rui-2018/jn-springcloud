...
public class TbOaWorkPlanUser implements Serializable {
    private String id;
    ...
    public void setResponsibleUserAccount(String responsibleUserAccount) {
        this.responsibleUserAccount = responsibleUserAccount == null ? null : responsibleUserAccount.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        TbOaWorkPlanUser other = (TbOaWorkPlanUser) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getWorkPlanId() == null ? other.getWorkPlanId() == null : this.getWorkPlanId().equals(other.getWorkPlanId()))
            && (this.getResponsibleUserAccount() == null ? other.getResponsibleUserAccount() == null : this.getResponsibleUserAccount().equals(other.getResponsibleUserAccount()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getResponsibleUserAccount() == null) ? 0 : getResponsibleUserAccount().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", responsibleUserAccount=").append(responsibleUserAccount);
