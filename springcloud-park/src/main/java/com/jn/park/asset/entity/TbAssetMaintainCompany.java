...
public class TbAssetMaintainCompany implements Serializable {
    /*@ApiModelProperty("")*/
    private String id;
    ...
    /*@ApiModelProperty("厂家对应用户列表（冗余字段，json格式）")*/
    ...
    public boolean equals(Object that) {
        ...
        TbAssetMaintainCompany other = (TbAssetMaintainCompany) that;
