...
public class TbElectricTurnRules implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        TbElectricTurnRules other = (TbElectricTurnRules) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getTurnContent() == null ? other.getTurnContent() == null : this.getTurnContent().equals(other.getTurnContent()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getTurnContent() == null) ? 0 : getTurnContent().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", turnContent=").append(turnContent);
