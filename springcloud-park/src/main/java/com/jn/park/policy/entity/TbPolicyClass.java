...
public class TbPolicyClass implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        TbPolicyClass other = (TbPolicyClass) that;
        return (this.getPolicyClassCode() == null ? other.getPolicyClassCode() == null : this.getPolicyClassCode().equals(other.getPolicyClassCode()))
