...
public class PayBillServiceImpl implements PayBillService {
     ...
     * 账单状态 1待支付
     */
    private static final String BILL_IS_WAIT_PAY = "1";
    ...
    public String createBill(@RequestBody PaymentBillModel paymentBillModel){
        ...
        tbPaymentBill.setBillStatus(BILL_IS_WAIT_PAY);
    ...
    @Override
    public  PayResponseVO startPayment(PayInitiateParam payInitiateParam){
