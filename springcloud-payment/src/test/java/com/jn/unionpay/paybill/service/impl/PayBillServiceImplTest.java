...
public class PayBillServiceImplTest {
    ...
    public void startPayment() {
        ...
        try {
            CreateOrderAndPayReqModel createOrderAndPayReqModel = new CreateOrderAndPayReqModel();
            Result result = payBillService.createPayOrder(createOrderAndPayReqModel);
