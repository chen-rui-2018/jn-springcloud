...
import com.jn.portals.user.model.PortalUserLogin;
...
public class PortalsLoginDataCheckServiceImpl implements PortalsLoginDataCheckService {
    ...
    public Result loginDataCheck(PortalUserLogin portalUserLogin) {
        ...
        if(StringUtils.isBlank(logintype)){
            ...
            result.setCode(PortalsLoginExceptionEnum.LOGIN_TYPE_CANNOT_EMPTY.getCode());
            result.setResult(PortalsLoginExceptionEnum.LOGIN_TYPE_CANNOT_EMPTY.getMessage());
            return  result;
        }
        if( !(loginTypeWeb.equals(logintype) || loginTypeSms.equals(logintype)||
            ...
            result.setCode(PortalsLoginExceptionEnum.LOGIN_TYPE_CANNOT_SUPPORT.getCode());
            result.setResult(PortalsLoginExceptionEnum.LOGIN_TYPE_CANNOT_SUPPORT.getMessage());
            return  result;
        }
        ...
        if(loginTypeSms.equals(logintype)){
            ...
            if(StringUtils.isBlank(smsCode) || !smsCode.equals(portalUserLogin.getPassword())){
                ...
                result.setCode(PortalsLoginExceptionEnum.SMS_CODE_ISERROR.getCode());
                result.setResult(PortalsLoginExceptionEnum.SMS_CODE_ISERROR.getMessage());
                return result;
            }
        }
        return result;
