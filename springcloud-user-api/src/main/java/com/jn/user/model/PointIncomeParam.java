...
public class PointIncomeParam implements Serializable {
    ...
    @ApiModelProperty(value = "积分规则代码[real_name:实名认证,published:发布动态,auth:企业认证,check_in:用户签到,order_pay:订单奖励,share:好友分享]",example = "check_in",required = true)
    @NotNull(message = "积分规则代码不能为空")
    private String ruleCode;

    @ApiModelProperty(value = "业务逻辑标识(业务侧的主键标识，非必填。列如'实名制'传实名制ID)",example = "7ce873bfb44e467684024d569a44f32r")
