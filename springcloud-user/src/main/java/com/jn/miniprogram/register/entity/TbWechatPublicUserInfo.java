package com.jn.miniprogram.register.entity;

import java.io.Serializable;
import java.util.Date;

public class TbWechatPublicUserInfo implements Serializable {
    private String id;
    ...
    public boolean equals(Object that) {
        ...
        TbWechatPublicUserInfo other = (TbWechatPublicUserInfo) that;
