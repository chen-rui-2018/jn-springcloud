 ...
 *
 * @Author： cm
 * @Date： Created on 2019/2/28 15:48
 * @Version： v1.0
 * @Modified By:
 */
public enum WxErrorMsgEnum implements CodeAndMsg {
    ...
    WxErrorMsgEnum(String code, String message) {
        this.code = code;
    ...
    public static String findMsgByCode(String code) {
        for (WxErrorMsgEnum value : WxErrorMsgEnum.values()) {
